...
$plugin->version = 2025060300;  // YYYYMMDDHH (year, month, day, 24-hr time).
$plugin->requires = 2024100700; // YYYYMMDDHH (This is the release version for Moodle 2.0).
$plugin->release = '4.5.0.0'; // Plugin release.
